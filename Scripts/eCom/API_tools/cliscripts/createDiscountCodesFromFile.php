...
$DiscountParams['minimum_after']    = (bool) Helper::getCLIAnswer('Should the minimum order value before or after discount. (1 for before, 0 for after)');
